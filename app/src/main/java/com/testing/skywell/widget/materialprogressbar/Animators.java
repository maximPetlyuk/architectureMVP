...
import com.testing.skywell.widget.materialprogressbar.internal.ObjectAnimatorCompat;
...
class Animators {
	...
	static
	{
		...
		PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.rCubicTo(48.89972f, 0, 166.02656f, 0, 301.21729f, 0);
		PATH_INDETERMINATE_HORIZONTAL_RECT1_TRANSLATE_X.rCubicTo(197.58128f, 0, 420.9827f, 0, 420.9827f, 0);
	}
	...
	static
	{
		...
		PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X.rCubicTo(14.28182f, 0, 85.07782f, 0, 135.54689f, 0);
		PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X.rCubicTo(54.26191f, 0, 90.42461f, 0, 168.24331f, 0);
		PATH_INDETERMINATE_HORIZONTAL_RECT2_TRANSLATE_X.rCubicTo(144.72154f, 0, 316.40982f, 0, 316.40982f, 0);
	}
	...
	/**
	 * Create a backported Animator for {@code @android:anim/progress_indeterminate_horizontal_rect1}.
	 * 
	 * @param target
	...
	/**
	 * Create a backported Animator for {@code @android:anim/progress_indeterminate_horizontal_rect2}.
	 * 
	 * @param target
	 *            The object whose properties are to be animated.
	 * @return An Animator object that is set up to behave the same as the its native counterpart.
	...
	public static Animator createIndeterminate(Object target) {
		...
		ObjectAnimator trimPathStartAnimator = ObjectAnimator.ofFloat(target, "trimPathStart", 0, 0.75f);
		...
		ObjectAnimator trimPathEndAnimator = ObjectAnimator.ofFloat(target, "trimPathEnd", 0, 0.75f);
		...
		ObjectAnimator trimPathOffsetAnimator = ObjectAnimator.ofFloat(target, "trimPathOffset", 0, 0.25f);
