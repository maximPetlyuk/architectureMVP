...
public class IndeterminateProgressDrawable extends IndeterminateProgressDrawableBase {
	 ...
	 * 
	 * @param context
	 *            the {@code Context} for retrieving style information.
	 */
	...
	private void drawRing(Canvas canvas, Paint paint) {
		...
		float startAngle = -90 + 360 * (mRingPathTransform.mTrimPathOffset + mRingPathTransform.mTrimPathStart);
		float sweepAngle = 360 * (mRingPathTransform.mTrimPathEnd - mRingPathTransform.mTrimPathStart);
