...
public interface TintableDrawable {
	 ...
	 * </p>
	 * <p class="note">
	 * <strong>Note:</strong> Setting a color filter via {@link Drawable#setColorFilter(ColorFilter)} or {@link Drawable#setColorFilter(int, PorterDuff.Mode)} overrides tint.
	 * </p>
	 * 
	 * @param tintColor
	 ...
	 * 
	 * @param tint
	 *            Color state list to use for tinting this drawable, or {@code null} to clear the tint
	 * @see #setTint(int)
	 * @see #setTintMode(PorterDuff.Mode)
	 */
