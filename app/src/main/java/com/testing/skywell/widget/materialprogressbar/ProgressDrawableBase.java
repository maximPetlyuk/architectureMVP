...
import com.testing.skywell.widget.materialprogressbar.internal.ThemeUtils;
...
abstract class ProgressDrawableBase extends Drawable implements IntrinsicPaddingDrawable, TintableDrawable {
	...
	public ProgressDrawableBase(Context context) {
		...
		//int colorControlActivated = 0xFFfaff3d;//ThemeUtils.getColorFromAttrRes(android.R.attr.colorControlActivated, context);
		int colorControlActivated = ThemeUtils.getColorFromAttrRes(android.R.attr.colorControlActivated, context);
	...
	private boolean needMirroring() {
		return mAutoMirrored;// && DrawableCompat.getLayoutDirection(this) == ViewCompat.LAYOUT_DIRECTION_RTL;
	}
